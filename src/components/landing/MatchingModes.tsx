...
export function MatchingModes() {
  ...
  return (
    <section id="prestataires" className="w-full bg-saubio-forest py-16 text-white">
      <div className="mx-auto grid w-full max-w-7xl gap-8 px-6 lg:grid-cols-2 lg:px-16">
